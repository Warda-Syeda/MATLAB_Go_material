...
% plot_data that plots mean, min, max and std calculated over all pokemons.

%% Challenge #2

%Display stem and scatter plots for CP_after against Pokedex number
...
%% Extension
% Using the 'hold' function plot the sorted before and after CP in the same figure. % See if you can use different colours to differentiate
